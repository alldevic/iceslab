...
#   ICESLAB_REF        Branch/tag/sha (default v0.1.9, pinned for alpha)
...
banner() {
  ...
  printf '  v0.1.9  ·  github.com/icecompany-tech/iceslab\n'
  printf '\n'
}
...
ICESLAB_REF=${ICESLAB_REF:-v0.1.9}
