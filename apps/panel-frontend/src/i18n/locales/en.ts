...
export default {
  ...
  users: {
    ...
    form: {
      ...
      importTokenDesc: 'optional - reuse an existing link on migration',
  ...
  cascades: {
    ...
    // Geo split on the entry hop + link-cell hint.
    split: 'Geo split (entry hop)',
    splitAddRule: 'Add rule',
    splitHint:
      'Matched traffic egresses direct / blocks / tunnels to s2, ahead of the default. Empty = no split. Bundled categories (e.g. category-ru, youtube) work as-is; custom ones ride an ext: file from the geo registry.',
    splitTarget: 'target',
    targetDirect: 'direct',
    targetTunnel: 'tunnel (s2)',
    targetBlock: 'block',
