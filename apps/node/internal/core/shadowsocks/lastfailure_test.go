...
// Why shadowsocks is down, as the panel gets to say it.
//
...
func lastFailureAdapter(t *testing.T) *Adapter { t.Helper(); return newConfigOnlyAdapter(t) }
